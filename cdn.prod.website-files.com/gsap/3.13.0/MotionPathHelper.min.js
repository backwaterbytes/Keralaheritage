...
! function(t, e) {
    ...
    function stringToRawPath(t) {
        ...
        var e, n, i, s, a, o, r, h, l, c, d, u, p, g, f, _ = (t + "").replace(w, function(t) {
                var e = +t;
        ...
        for (e = 0; e < y; e++)
            if (p = a, isNaN(_[e]) ? o = (a = _[e].toUpperCase()) !== _[e] : e--, i = +_[e + 1], s = +_[e + 2], o && (i += v, s += b), e || (h = i, l = s), "M" === a) r && (r.length < 8 ? --m.length : P += r.length), v = h = i, b = l = s, r = [i, s], m.push(r), e += 2, a = "L";
        ...
        else if ("L" === a || "Z" === a) "Z" === a && (i = h, s = l, r.closed = !0), ("L" === a || .5 < Q(v - i) || .5 < Q(b - s)) && (sd(v, b, i, s), "L" === a && (e += 2)), v = i, b = s;
        else if ("A" === a) {
            if (g = _[e + 4], f = _[e + 5], c = _[e + 6], d = _[e + 7], n = 7, 1 < g.length && (g.length < 3 ? (d = c, c = f, n--) : (d = f, c = g.substr(2), n -= 2), f = g.charAt(1), g = g.charAt(0)), u = arcToSegment(v, b, +_[e + 1], +_[e + 2], +_[e + 3], +g, +f, (o ? v : 0) + 1 * c, (o ? b : 0) + 1 * d), e += n, u)
    ...
    function simplifyPoints(t, e) {
        ...
        return d.push(parseFloat(t[u]), parseFloat(t[1 + u])),
            function simplifyStep(t, e, n, i, s) {
                var a, o, r, h, l, c, d, u, p, g, f, _, m = i,
                    v = t[e],
                    b = t[e + 1],
                    y = t[n],
                    P = t[n + 1];
    ...
    function M(t, e) {
        ...
        if (c.length || c.push(J(t, 1), J(t, 2), J(t, 3)), n = h ? v : m, h) l ? (a = -(s = function _getCTM(t) {
            ...
            return e
        }(i) : i.getItem(0).matrix : b).a * s.x + i.c * s.y, o = i.b * s.x + i.d * s.y) : (i = new T, a = o = 0), e && "g" === t.tagName.toLowerCase() && (a = o = 0), (l ? h : d).appendChild(n), n.setAttribute("transform", "matrix(" + i.a + "," + i.b + "," + i.c + "," + i.d + "," + (i.e + a) + "," + (i.f + o) + ")");
        else {
            if (a = o = 0, S)
                for (i = t.offsetParent, s = t;
                    (s = s && s.parentNode) && s !== i && s.parentNode;) 4 < (g.getComputedStyle(s)[x] + "").length && (a = s.offsetLeft, o = s.offsetTop, s = 0);
            if ("absolute" !== (r = g.getComputedStyle(t)).position && "fixed" !== r.position)
    ...
    var p, g, f, _, m, v, b, y, S, e, x = "transform",
        E = x + "Origin",
        k = [],
        D = [],
    ...
    var R, h, c, i, s, r, l, u, L, d, X, a, O, I, G, q, z = /(?:(-)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
        V = "#4e7fff",
    ...
    var ct, dt = ((ct = PathEditor.prototype)._onRelease = function _onRelease(t) {
        ...
        if (this._rawPath = i, a) {
            if (this._anchors = Pa(i, 0, this, o), 1 < (t = i.length))
                for (e = 1; e < t; e++) this._anchors = this._anchors.concat(Pa(i, e, this, o))
        } else
        ...
        return this._selection.appendChild(this._handle1), this._selection.appendChild(this._handle2), this._selectionPath.setAttribute("d", n), this._selectionHittest.setAttribute("d", n), this._g.setAttribute("transform", function _getConcatenatedTransforms(t) {
            for (var e = ra(t), n = t.ownerSVGElement;
                (t = t.parentNode) && t.ownerSVGElement === n;) e.multiply(ra(t));
        ...
        if ("hidden" === this._selection.style.visibility) this.select();
            ...
            for (this._draggable && this._draggable._onRelease(t), l && (a = t.clientX * l.a + t.clientY * l.c + l.e, o = t.clientX * l.b + t.clientY * l.d + l.f), r = function getClosestData(t, e, n, i) {
                    ...
                    for (a = 0; a < t.length; a++)
                        for (r = t[a], s = 0; s < r.length; s += 6) o = getClosestProgressOnBezier(1, e, n, 0, 1, i || 20, r[s], r[s + 1], r[s + 2], r[s + 3], r[s + 4], r[s + 5], r[s + 6], r[s + 7]), P < l && (l = P, h.j = a, h.i = s, h.t = o);
                    return h
    ...
    var ut, pt, gt, ft, _t, mt, vt, bt, yt, Pt, At = /(^[#\.][a-z]|[a-y][a-z])/i,
        Ct = {
            matrix: {
                a: 1,
                b: 0,
    ...
    function MotionPathHelper(t, e) {
        ...
        var i, s, a, o, r, h, l, c, d, u, p, g, f, _, m = db("div"),
            v = this,
            b = {
                x: 0,
                y: 0
