...
! function(t, e) {
    ...
    function A(t, e) {
        ...
        if (h.length || h.push(x(t, 1), x(t, 2), x(t, 3)), i = l ? d : f, l) u ? (a = -(r = z(t)).e / r.a, s = -r.f / r.d, n = m) : t.getBBox ? (r = t.getBBox(), a = (n = (n = t.transform ? t.transform.baseVal : {}).numberOfItems ? 1 < n.numberOfItems ? function _consolidate(t) {
            ...
            return e
        }(n) : n.getItem(0).matrix : m).a * r.x + n.c * r.y, s = n.b * r.x + n.d * r.y) : (n = new F, a = s = 0), e && "g" === t.tagName.toLowerCase() && (a = s = 0), (u ? l : p).appendChild(i), i.setAttribute("transform", "matrix(" + n.a + "," + n.b + "," + n.c + "," + n.d + "," + (n.e + a) + "," + (n.f + s) + ")");
        else {
            if (a = s = 0, w)
                for (n = t.offsetParent, r = t;
                    (r = r && r.parentNode) && r !== n && r.parentNode;) 4 < (y.getComputedStyle(r)[k] + "").length && (a = r.offsetLeft, s = r.offsetTop, r = 0);
    ...
    var g, y, a, b, f, d, m, s, w, i, k = "transform",
        C = k + "Origin",
        E = [],
        M = [],
    ...
    function Aa(t, e, r, i) {
        ...
        var a, s, o, l, u, h, p, c, f, n, d, m, g, v, y, x = (r = r || {}).clearProps,
            b = r.onEnter,
            w = r.onLeave,
            S = r.absolute,
            k = r.absoluteOnLeave,
        ...
        z && (st[z] || ba(z)).forEach(function(e) {
            ...
            if (it.forEach(function(t) {
                ...
                for (s in W = _(Y, rt), "scale" in C && (C.scaleX = C.scaleY = C.scale, delete C.scale), C)(a = _(C[s], at))[s] = Y[s], !("duration" in a) && "duration" in Y && (a.duration = Y.duration), a.stagger = Y.stagger, U.call(R, c, a, 0), delete W[s];
    ...
    var q, ht = ((q = ElementState.prototype).isDifferent = function isDifferent(t) {
        var e = this.bounds,
            i = t.bounds;
